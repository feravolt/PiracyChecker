@file:Suppress(
    "SameReturnValue", "SameParameterValue", "SameParameterValue", "SameParameterValue",
    "SameParameterValue"
)
...
import com.github.javiersantos.R
...
private fun Context.hasPermissions(): Boolean {
    return try {
        !shouldAskPermission(Manifest.permission.READ_EXTERNAL_STORAGE) || !ActivityCompat.shouldShowRequestPermissionRationale(
...
private fun shouldAskPermission(): Boolean = true
